...
import { Sparkles, SlidersHorizontal, Users, ShieldAlert, Bot, Hospital, Terminal } from 'lucide-react';
...
const VIEWS = [
  ...
  { id: 'agents', label: 'Agent ops', Icon: Bot },
...
export function App() {
  ...
  const [view, setView] = useState(() => remember('mdin.view', 'patients'));
