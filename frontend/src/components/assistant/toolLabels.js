...
export const TOOL_LABELS = {
  ...
  check_medical_coverage_pathway: 'Checked insurance against published policy',
  get_visit: 'Checked the visit',
  mark_procedure_done: 'Marked the procedure done',
  set_patient_insurance: 'Saved insurance details',
  attach_plan_document: 'Saved the plan document',
  create_coverage_document: 'Filed the insurance document',
  close_visit: 'Closed the visit',
